        ...
        <>
            ...
            <div className="flex bg-amber-100">
                <div className="w-full flex flex-col items-center">
                    ...
                    <Link className="text-maplered text-xl mt-5 sm:mt-15 py-1 px-3 bg-mapletan rounded-xl border-4 border-mapleorange hover:cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110" to="/box-office">BOOK A TICKET</Link>
                </div>
            ...
            <div className="flex bg-maplebrown">  
                ...
                <div className="w-full flex flex-col items-center">
                    ...
                    <Link className="text-white text-xl mt-5 sm:mt-15 py-1 px-3 bg-maplegreen rounded-xl border-4 border-mapleorange hover:cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110" to="/box-office">LEARN MORE</Link>
                </div>
            </div>
            <Footer />
        </>
