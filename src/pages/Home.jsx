        ...
        <>
            ...
            <div className="flex ">
                <div className="w-full h-90 bg-cover flex flex-col items-center" style={{ backgroundImage: `url(${gymImage})` }}>
                    ...
                    <Link className="mb-2 relative top-0 right-0 mt-1 sm:mt-15 py-1 px-3 bg-maplegreen rounded-xl border-4 border-mapleorange hover:cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110 text-white text-xl font-bold" to="/rentals">RENTALS & DATES</Link>
                </div>
            </div>
            <div className="flex bg-amber-100">
                <div className="w-full flex flex-col items-center">
                    ...
                    <Link className="mb-2 text-maplered text-xl mt-5 sm:mt-15 py-1 px-3 bg-mapletan rounded-xl border-4 border-mapleorange hover:cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110 font-bold" to="/box-office">BOOK A TICKET</Link>
                </div>
            ...
            <div className="flex bg-maplebrown">  
                ...
                <div className="w-full flex flex-col items-center">
                    ...
                    <p className="mt-5 mx-5 text-center text-xl sm:mx-15">Our gymnasium hosts a multitude of events and sports such as basketball, concerts, and volleyball. <span className="font-bold">Learn more about its specifics!</span></p>
                    <Link className="mb-2 text-white text-xl mt-5 sm:mt-15 py-1 px-3 bg-maplegreen rounded-xl border-4 border-mapleorange hover:cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110 font-bold" to="/about-us">LEARN MORE</Link>
                </div>
            </div>
            <Footer />
        </>
