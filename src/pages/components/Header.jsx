...
export default function Header() {
    ...
    return (
        <>
            <div className="sticky top-0 z-50 flex align-items-center bg-black">
                ...
                <h1 className="w-full justify-center text-left mt-1 text-[1.2rem] sm:m-0 sm:text-[4rem] p-6 font-bold text-white truncate">MAPLE RIDGE <span className="hidden lg:inline">BUCKS</span></h1>
                ...
                <div className={`absolute right-0 top-full lg:bg-amber-700 w-full opacity-100 z-50 transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : 'hidden translate-x-full'}`}>
                    <div className="flex flex-col justify-end ml-auto sm:hidden justify-items-center items-center bg-mapletan w-8/10">
                        ...
                        <Link className="p-5 text-lg font-bold hover:text-slate-600 active:underline transition-transform duration-300 ease-in-out transform hover:scale-110 active:scale-110" to="/info">INFO</Link>
            ...
            <nav className="flex top-0 left-0">
                ...
                <div className="hidden sm:flex justify-around justify-items-center items-center bg-mapletan w-full h-20">
                    ...
                    <Link className="text-lg font-bold hover:text-slate-600 active:underline transition-transform duration-300 ease-in-out transform hover:scale-110 active:scale-110" to="/info">INFO</Link>
