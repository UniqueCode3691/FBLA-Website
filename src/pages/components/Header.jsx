...
export default function Header() {
    ...
    return (
        <nav className="relative top-0 left-0">
            <div className="flex align-items-center bg-black">
            ...
            <div className={`absolute right-0 w-full opacity-100 z-50 transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
